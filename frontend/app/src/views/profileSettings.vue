<template>
  <div class="flex flex-col m-8 md:ml-72 overflow-y-auto h-[80vh]">
    ...
    <div class="w-full max-w-3xl space-y-6">
      ...
      <div class="flex">
        ...
        <div>
          <img :src=profile.profile_picture_url alt="Description of image"
            style="width: 100px; height:100px; object-fit: cover; object-position: start; display: block ; border-radius: 4px">
  ...
  methods: {
    ...
    async updateProfile() {
      ...
      try {
        ...
        const response = await axios.post(`${this.apiUrl}/update-profile/`, payload, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
